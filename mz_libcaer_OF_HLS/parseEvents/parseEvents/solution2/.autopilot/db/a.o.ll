; ModuleID = 'E:/xfOpenCV/wksp_2018_1/mz_libcaer_OF_HLS/parseEvents/parseEvents/solution2/.autopilot/db/a.o.bc'
...
define internal void @_Z19resetCurrentSliceHWv() nounwind {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([180 x [240 x i8]]* getelementptr inbounds ([3 x [180 x [240 x i8]]]* @_ZL10glPLSlices, i32 0, i32 0), i32 3, i8* getelementptr inbounds ([6 x i8]* @.str3, i32 0, i32 0), i32 1, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !105 ; [debug line = 28:1]
  br label %1, !dbg !105                          ; [debug line = 28:1]
...
; <label>:6                                       ; preds = %2
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !111 ; [debug line = 30:3]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !111 ; [debug line = 30:3]
...
; <label>:12                                      ; preds = %8
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([16 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !118 ; [debug line = 32:4]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([16 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !118 ; [debug line = 32:4]
  ...
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([16 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !122 ; [debug line = 34:3]
...
; <label>:25                                      ; preds = %8
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !124 ; [debug line = 35:2]
...
define void @_Z11parseEventsPKjiPa(i32* %data, i32 %eventsArraySize, i8* %eventSlice) nounwind {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32* %4, i8* getelementptr inbounds ([8 x i8]* @.str6, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !133 ; [debug line = 40:1]
...
!105 = metadata !{i32 28, i32 1, metadata !106, null}
