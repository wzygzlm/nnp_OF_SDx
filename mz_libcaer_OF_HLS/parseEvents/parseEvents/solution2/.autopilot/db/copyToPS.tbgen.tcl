...
set C_modelArgList {
	...
	{ glPLSlices int 8 regular {array 129600 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "eventSlice", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "glPLSlices", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ glPLSlices_address0 sc_out sc_lv 17 signal 2 } 
	{ glPLSlices_ce0 sc_out sc_logic 1 signal 2 } 
	{ glPLSlices_q0 sc_in sc_lv 8 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "glPLSlices_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "glPLSlices", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.parseEvents_urem_bkb_U2", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.parseEvents_urem_bkb_U3", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	glPLSlices { ap_memory {  { glPLSlices_address0 mem_address 1 17 }  { glPLSlices_ce0 mem_ce 1 1 }  { glPLSlices_q0 mem_dout 0 8 } } }
}
