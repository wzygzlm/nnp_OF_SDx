...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "64833", "EstimateLatencyMax" : "84834",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"InDataflowNetwork" : "0",
		"WaitState" : [
			{"State" : "ap_ST_fsm_state2", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_resetCurrentSliceHW_fu_144"},
			{"State" : "ap_ST_fsm_state8", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_copyToPS_fu_150"}],
		"Port" : [
			{"Name" : "eventSlice", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_copyToPS_fu_150", "Port" : "eventSlice"}]},
			...
			{"Name" : "glPLSlices", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_copyToPS_fu_150", "Port" : "glPLSlices"},
					{"ID" : "3", "SubInstance" : "grp_resetCurrentSliceHW_fu_144", "Port" : "glPLSlices"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.glPLSlices_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.parseEvents_eventSlice_m_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_resetCurrentSliceHW_fu_144", "Parent" : "0",
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_copyToPS_fu_150", "Parent" : "0", "Child" : ["5", "6"],
		"CDFG" : "copyToPS",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "eventSlice_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "glPLSlices", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_copyToPS_fu_150.parseEvents_urem_bkb_U2", "Parent" : "4"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_copyToPS_fu_150.parseEvents_urem_bkb_U3", "Parent" : "4"}]}
...
set ArgLastReadFirstWriteLatency {
	parseEvents {
		...
		glPLSlices {Type IO LastRead -1 FirstWrite -1}}
	resetCurrentSliceHW {
		glPLSlices {Type O LastRead -1 FirstWrite 1}}
	copyToPS {
		eventSlice {Type O LastRead 23 FirstWrite 22}
		eventSlice_offset {Type I LastRead 0 FirstWrite -1}
		glPLSlices {Type I LastRead 3 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "64833", "Max" : "84834"}
	, {"Name" : "Interval", "Min" : "64834", "Max" : "84835"}
]}
