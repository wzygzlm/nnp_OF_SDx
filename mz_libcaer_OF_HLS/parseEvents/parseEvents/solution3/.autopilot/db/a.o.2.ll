...
@glPLSlices.3 = internal unnamed_addr global [3 x [180 x [60 x i8]]] zeroinitializer ; [#uses=62 type=[3 x [180 x [60 x i8]]]*]
@glPLSlices.2 = internal unnamed_addr global [3 x [180 x [60 x i8]]] zeroinitializer ; [#uses=62 type=[3 x [180 x [60 x i8]]]*]
@glPLSlices.1 = internal unnamed_addr global [3 x [180 x [60 x i8]]] zeroinitializer ; [#uses=62 type=[3 x [180 x [60 x i8]]]*]
@glPLSlices.0 = internal unnamed_addr global [3 x [180 x [60 x i8]]] zeroinitializer ; [#uses=62 type=[3 x [180 x [60 x i8]]]*]
...
; <label>:2                                       ; preds = %1
  ...
  %x.cast = trunc i32 %tmp.5 to i15, !dbg !104    ; [#uses=2 type=i15] [debug line = 46:45]
  %tmp.6 = lshr i18 %data.load.cast, 2, !dbg !105 ; [#uses=1 type=i18] [debug line = 47:44]
  %y = trunc i18 %tmp.6 to i15, !dbg !105         ; [#uses=1 type=i15] [debug line = 47:44]
  call void @llvm.dbg.value(metadata !{i15 %y}, i64 0, metadata !106), !dbg !105 ; [debug line = 47:44] [debug variable = y]
  %pol = icmp sgt i2 %data.load.cast1, -1, !dbg !107 ; [#uses=1 type=i1] [debug line = 48:43]
  call void @llvm.dbg.value(metadata !{i1 %pol}, i64 0, metadata !108), !dbg !107 ; [debug line = 48:43] [debug variable = pol]
  call void @llvm.dbg.value(metadata !{i15 %y}, i64 0, metadata !109) nounwind, !dbg !111 ; [debug line = 6:38@52:3] [debug variable = y]
  call void @llvm.dbg.value(metadata !{i1 %pol}, i64 0, metadata !112) nounwind, !dbg !113 ; [debug line = 6:46@52:3] [debug variable = pol]
  br i1 %pol, label %accumulateHW.exit, label %3, !dbg !114 ; [debug line = 8:2@52:3]

; <label>:3                                       ; preds = %2
  %tmp..i1 = zext i15 %y to i32, !dbg !116        ; [#uses=4 type=i32] [debug line = 10:3@52:3]
  %arrayNo.i = udiv i15 %x.cast, 60               ; [#uses=2 type=i15]
  %arrayNo.i.cast = zext i15 %arrayNo.i to i16    ; [#uses=1 type=i16]
  %newIndex.i = urem i15 %x.cast, 60              ; [#uses=1 type=i15]
  %newIndex1.i = zext i15 %newIndex.i to i32      ; [#uses=4 type=i32]
  %glPLSlices.0.addr = getelementptr [3 x [180 x [60 x i8]]]* @glPLSlices.0, i32 0, i32 0, i32 %tmp..i1, i32 %newIndex1.i, !dbg !116 ; [#uses=2 type=i8*] [debug line = 10:3@52:3]
  %glPLSlices.1.addr = getelementptr [3 x [180 x [60 x i8]]]* @glPLSlices.1, i32 0, i32 0, i32 %tmp..i1, i32 %newIndex1.i, !dbg !116 ; [#uses=2 type=i8*] [debug line = 10:3@52:3]
  %glPLSlices.2.addr = getelementptr [3 x [180 x [60 x i8]]]* @glPLSlices.2, i32 0, i32 0, i32 %tmp..i1, i32 %newIndex1.i, !dbg !116 ; [#uses=2 type=i8*] [debug line = 10:3@52:3]
  %glPLSlices.3.addr = getelementptr [3 x [180 x [60 x i8]]]* @glPLSlices.3, i32 0, i32 0, i32 %tmp..i1, i32 %newIndex1.i, !dbg !116 ; [#uses=2 type=i8*] [debug line = 10:3@52:3]
  ...
  %tmp.1 = call i8 @_ssdm_op_Mux.ap_auto.4i8.i16(i8 %glPLSlices.0.load, i8 %glPLSlices.1.load, i8 %glPLSlices.2.load, i8 %glPLSlices.3.load, i16 %arrayNo.i.cast) nounwind ; [#uses=1 type=i8]
  %tmp.3.i = add i8 %tmp.1, 1, !dbg !116          ; [#uses=4 type=i8] [debug line = 10:3@52:3]
  switch i15 %arrayNo.i, label %branch3.i [
    i15 0, label %branch0.i
    i15 1, label %branch1.i
    i15 2, label %branch2.i
  ], !dbg !116                                    ; [debug line = 10:3@52:3]

; <label>:4                                       ; preds = %branch3.i, %branch2.i, %branch1.i, %branch0.i
  br label %accumulateHW.exit, !dbg !118          ; [debug line = 11:2@52:3]

branch0.i:                                        ; preds = %3
  store i8 %tmp.3.i, i8* %glPLSlices.0.addr, align 1, !dbg !116 ; [debug line = 10:3@52:3]
  br label %4, !dbg !116                          ; [debug line = 10:3@52:3]

branch1.i:                                        ; preds = %3
  store i8 %tmp.3.i, i8* %glPLSlices.1.addr, align 1, !dbg !116 ; [debug line = 10:3@52:3]
  br label %4, !dbg !116                          ; [debug line = 10:3@52:3]

branch2.i:                                        ; preds = %3
  store i8 %tmp.3.i, i8* %glPLSlices.2.addr, align 1, !dbg !116 ; [debug line = 10:3@52:3]
  br label %4, !dbg !116                          ; [debug line = 10:3@52:3]

branch3.i:                                        ; preds = %3
  store i8 %tmp.3.i, i8* %glPLSlices.3.addr, align 1, !dbg !116 ; [debug line = 10:3@52:3]
  br label %4, !dbg !116                          ; [debug line = 10:3@52:3]

accumulateHW.exit:                                ; preds = %4, %2
  %5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @.str10, i32 %tmp.2) nounwind, !dbg !119 ; [#uses=0 type=i32] [debug line = 53:2]
  %i.2 = add nsw i32 %i, 2, !dbg !120             ; [#uses=1 type=i32] [debug line = 43:53]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !121), !dbg !120 ; [debug line = 43:53] [debug variable = i]
  br label %1, !dbg !120                          ; [debug line = 43:53]

; <label>:6                                       ; preds = %1
  call fastcc void @copyToPS(i8* %eventSlice), !dbg !122 ; [debug line = 55:2]
  ret void, !dbg !123                             ; [debug line = 56:1]
}
...
define internal fastcc void @copyToPS(i8* %eventSlice) nounwind {
  ...
  call void @llvm.dbg.value(metadata !{i8* %eventSlice}, i64 0, metadata !124), !dbg !128 ; [debug line = 15:23] [debug variable = eventSlice]
  br label %1, !dbg !129                          ; [debug line = 17:33]

; <label>:1                                       ; preds = %7, %0
  %i = phi i8 [ 0, %0 ], [ %i.3, %7 ]             ; [#uses=5 type=i8]
  %exitcond1 = icmp eq i8 %i, -76, !dbg !129      ; [#uses=1 type=i1] [debug line = 17:33]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 180, i64 180, i64 180)
  br i1 %exitcond1, label %9, label %2, !dbg !129 ; [debug line = 17:33]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @.str) nounwind, !dbg !132 ; [debug line = 18:3]
  %tmp.3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @.str) nounwind, !dbg !132 ; [#uses=1 type=i32] [debug line = 18:3]
  %tmp = zext i8 %i to i32, !dbg !134             ; [#uses=4 type=i32] [debug line = 21:4]
  %tmp.cast2 = zext i8 %i to i12, !dbg !134       ; [#uses=1 type=i12] [debug line = 21:4]
  %tmp.cast = zext i8 %i to i16, !dbg !134        ; [#uses=1 type=i16] [debug line = 21:4]
  %_shl = shl nuw i16 %tmp.cast, 8, !dbg !134     ; [#uses=1 type=i16] [debug line = 21:4]
  %_shl.cast = zext i16 %_shl to i17, !dbg !134   ; [#uses=1 type=i17] [debug line = 21:4]
  %_shl1 = shl nuw i12 %tmp.cast2, 4, !dbg !134   ; [#uses=1 type=i12] [debug line = 21:4]
  %_shl1.cast = zext i12 %_shl1 to i17, !dbg !134 ; [#uses=1 type=i17] [debug line = 21:4]
  %tmp. = sub i17 %_shl.cast, %_shl1.cast, !dbg !134 ; [#uses=2 type=i17] [debug line = 21:4]
  %tmp.5 = zext i8 0 to i17                       ; [#uses=1 type=i17]
  %tmp.6 = add i17 %tmp.5, %tmp., !dbg !134       ; [#uses=1 type=i17] [debug line = 21:4]
  %tmp.7 = sext i17 %tmp.6 to i32, !dbg !134      ; [#uses=1 type=i32] [debug line = 21:4]
  br label %3, !dbg !137                          ; [debug line = 19:36]

; <label>:3                                       ; preds = %4, %2
  %j = phi i8 [ 0, %2 ], [ %j.1, %4 ]             ; [#uses=5 type=i8]
  %exitcond = icmp eq i8 %j, -16, !dbg !137       ; [#uses=1 type=i1] [debug line = 19:36]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 240, i64 240, i64 240)
  br i1 %exitcond, label %7, label %4, !dbg !137  ; [debug line = 19:36]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName([16 x i8]* @.str1) nounwind, !dbg !138 ; [debug line = 20:4]
  %tmp.4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([16 x i8]* @.str1) nounwind, !dbg !138 ; [#uses=1 type=i32] [debug line = 20:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str2) nounwind, !dbg !139 ; [debug line = 21:1]
  %tmp.1.cast = zext i8 %j to i17                 ; [#uses=1 type=i17]
  %arrayNo = udiv i8 %j, 60                       ; [#uses=1 type=i8]
  %arrayNo.cast = zext i8 %arrayNo to i16         ; [#uses=1 type=i16]
  %newIndex = urem i8 %j, 60                      ; [#uses=1 type=i8]
  %newIndex2 = zext i8 %newIndex to i32           ; [#uses=4 type=i32]
  %glPLSlices.0.addr = getelementptr [3 x [180 x [60 x i8]]]* @glPLSlices.0, i32 0, i32 0, i32 %tmp, i32 %newIndex2 ; [#uses=1 type=i8*]
  %glPLSlices.0.load = load i8* %glPLSlices.0.addr, align 1 ; [#uses=1 type=i8]
  %glPLSlices.1.addr = getelementptr [3 x [180 x [60 x i8]]]* @glPLSlices.1, i32 0, i32 0, i32 %tmp, i32 %newIndex2 ; [#uses=1 type=i8*]
  %glPLSlices.1.load = load i8* %glPLSlices.1.addr, align 1 ; [#uses=1 type=i8]
  %glPLSlices.2.addr = getelementptr [3 x [180 x [60 x i8]]]* @glPLSlices.2, i32 0, i32 0, i32 %tmp, i32 %newIndex2 ; [#uses=1 type=i8*]
  %glPLSlices.2.load = load i8* %glPLSlices.2.addr, align 1 ; [#uses=1 type=i8]
  %glPLSlices.3.addr = getelementptr [3 x [180 x [60 x i8]]]* @glPLSlices.3, i32 0, i32 0, i32 %tmp, i32 %newIndex2 ; [#uses=1 type=i8*]
  %glPLSlices.3.load = load i8* %glPLSlices.3.addr, align 1 ; [#uses=1 type=i8]
  %tmp.8 = call i8 @_ssdm_op_Mux.ap_auto.4i8.i16(i8 %glPLSlices.0.load, i8 %glPLSlices.1.load, i8 %glPLSlices.2.load, i8 %glPLSlices.3.load, i16 %arrayNo.cast) nounwind ; [#uses=1 type=i8]
  %tmp.2 = add i17 %tmp.1.cast, %tmp., !dbg !134  ; [#uses=1 type=i17] [debug line = 21:4]
  %tmp.2.cast = sext i17 %tmp.2 to i32, !dbg !134 ; [#uses=1 type=i32] [debug line = 21:4]
  %eventSlice.addr = getelementptr inbounds i8* %eventSlice, i32 %tmp.2.cast, !dbg !134 ; [#uses=1 type=i8*] [debug line = 21:4]
  %eventSlice.addr.1 = getelementptr inbounds i8* %eventSlice, i32 %tmp.7, !dbg !134 ; [#uses=1 type=i8*] [debug line = 21:4]
  %tmp.9 = zext i8 -16 to i32                     ; [#uses=1 type=i32]
  %5 = call i32 (...)* @_ssdm_op_SpecBurst(i8* %eventSlice.addr.1, i32 0, i32 %tmp.9, i32 1) ; [#uses=0 type=i32]
  store i8 %tmp.8, i8* %eventSlice.addr, align 1, !dbg !134 ; [debug line = 21:4]
  %6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([16 x i8]* @.str1, i32 %tmp.4) nounwind, !dbg !140 ; [#uses=0 type=i32] [debug line = 22:3]
  %j.1 = add i8 %j, 1, !dbg !141                  ; [#uses=1 type=i8] [debug line = 19:47]
  call void @llvm.dbg.value(metadata !{i8 %j.1}, i64 0, metadata !142), !dbg !141 ; [debug line = 19:47] [debug variable = j]
  br label %3, !dbg !141                          ; [debug line = 19:47]

; <label>:7                                       ; preds = %3
  %8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @.str, i32 %tmp.3) nounwind, !dbg !143 ; [#uses=0 type=i32] [debug line = 23:2]
  %i.3 = add i8 %i, 1, !dbg !144                  ; [#uses=1 type=i8] [debug line = 17:44]
  call void @llvm.dbg.value(metadata !{i8 %i.3}, i64 0, metadata !145), !dbg !144 ; [debug line = 17:44] [debug variable = i]
  br label %1, !dbg !144                          ; [debug line = 17:44]

; <label>:9                                       ; preds = %1
  ret void, !dbg !146                             ; [debug line = 24:1]
}
...
; [#uses=2]
declare i8 @_ssdm_op_Mux.ap_auto.4i8.i16(i8, i8, i8, i8, i16)
...
!105 = metadata !{i32 47, i32 44, metadata !102, null}
!106 = metadata !{i32 786688, metadata !102, metadata !"y", metadata !27, i32 47, metadata !30, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!107 = metadata !{i32 48, i32 43, metadata !102, null}
!108 = metadata !{i32 786688, metadata !102, metadata !"pol", metadata !27, i32 48, metadata !32, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!109 = metadata !{i32 786689, metadata !26, metadata !"y", metadata !27, i32 33554438, metadata !30, i32 0, metadata !110} ; [ DW_TAG_arg_variable ]
!110 = metadata !{i32 52, i32 3, metadata !102, null}
!111 = metadata !{i32 6, i32 38, metadata !26, metadata !110}
!112 = metadata !{i32 786689, metadata !26, metadata !"pol", metadata !27, i32 50331654, metadata !32, i32 0, metadata !110} ; [ DW_TAG_arg_variable ]
!113 = metadata !{i32 6, i32 46, metadata !26, metadata !110}
!114 = metadata !{i32 8, i32 2, metadata !115, metadata !110}
!115 = metadata !{i32 786443, metadata !26, i32 7, i32 1, metadata !27, i32 0} ; [ DW_TAG_lexical_block ]
!116 = metadata !{i32 10, i32 3, metadata !117, metadata !110}
!117 = metadata !{i32 786443, metadata !115, i32 9, i32 2, metadata !27, i32 1} ; [ DW_TAG_lexical_block ]
!118 = metadata !{i32 11, i32 2, metadata !117, metadata !110}
!119 = metadata !{i32 53, i32 2, metadata !102, null}
!120 = metadata !{i32 43, i32 53, metadata !100, null}
!121 = metadata !{i32 786688, metadata !100, metadata !"i", metadata !27, i32 43, metadata !88, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!122 = metadata !{i32 55, i32 2, metadata !97, null}
!123 = metadata !{i32 56, i32 1, metadata !97, null}
!124 = metadata !{i32 786689, metadata !125, metadata !"eventSlice", metadata !27, i32 16777231, metadata !90, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!125 = metadata !{i32 786478, i32 0, metadata !27, metadata !"copyToPS", metadata !"copyToPS", metadata !"_Z8copyToPSPa", metadata !27, i32 15, metadata !126, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i8*)* @copyToPS, null, null, metadata !35, i32 16} ; [ DW_TAG_subprogram ]
!126 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !127, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!127 = metadata !{null, metadata !90}
!128 = metadata !{i32 15, i32 23, metadata !125, null}
!129 = metadata !{i32 17, i32 33, metadata !130, null}
!130 = metadata !{i32 786443, metadata !131, i32 17, i32 16, metadata !27, i32 3} ; [ DW_TAG_lexical_block ]
!131 = metadata !{i32 786443, metadata !125, i32 16, i32 1, metadata !27, i32 2} ; [ DW_TAG_lexical_block ]
!132 = metadata !{i32 18, i32 3, metadata !133, null}
!133 = metadata !{i32 786443, metadata !130, i32 18, i32 2, metadata !27, i32 4} ; [ DW_TAG_lexical_block ]
!134 = metadata !{i32 21, i32 4, metadata !135, null}
!135 = metadata !{i32 786443, metadata !136, i32 20, i32 3, metadata !27, i32 6} ; [ DW_TAG_lexical_block ]
!136 = metadata !{i32 786443, metadata !133, i32 19, i32 19, metadata !27, i32 5} ; [ DW_TAG_lexical_block ]
!137 = metadata !{i32 19, i32 36, metadata !136, null}
!138 = metadata !{i32 20, i32 4, metadata !135, null}
!139 = metadata !{i32 21, i32 1, metadata !135, null}
!140 = metadata !{i32 22, i32 3, metadata !135, null}
!141 = metadata !{i32 19, i32 47, metadata !136, null}
!142 = metadata !{i32 786688, metadata !136, metadata !"j", metadata !27, i32 19, metadata !30, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!143 = metadata !{i32 23, i32 2, metadata !133, null}
!144 = metadata !{i32 17, i32 44, metadata !130, null}
!145 = metadata !{i32 786688, metadata !130, metadata !"i", metadata !27, i32 17, metadata !30, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!146 = metadata !{i32 24, i32 1, metadata !131, null}
